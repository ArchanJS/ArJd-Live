      ...
      <main>
        ...
        >
          <Container maxWidth="sm">
            ...
            A realtime code-editor and compiler to ease coding interview process. Users can create their rooms and can invite others to their rooms. So, millions can work on same code at the same time together !
            </Typography>
            <Stack
              sx={{ pt: 4 }}
              direction="row"
